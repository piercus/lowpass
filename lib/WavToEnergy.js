...
function WavToEnergy(options) {
  // allow use without new
  if (!(this instanceof EnergyDetector)) {
    return new WavToEnergy(options);
  }
  ...
  console.log(this.nBytesWindow,this.energyWindow,this.sampleRate);
...
util.inherits(WavToEnergy, Transform);

WavToEnergy.prototype._transform = function (chunk, enc, cb) {
